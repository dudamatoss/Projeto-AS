        ...
        <center>
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow p-4">
                <div class="flex flex-col items-center pb-10">
                    <h6 class="mb-1 text-xl font-medium text-gray-900">{{$entity->descricao}}</h6>
                    <span class="text-sm text-gray-500">{{$entity->preco}}</span>
                    <span class="text-sm text-gray-500"> {{ $entity->categoria->description }}</span>
